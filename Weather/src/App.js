...
import { StyleSheet, Text, View, Image, Pressable, FlatList, processColor } from 'react-native';
...
function ShowImg(props) {
    switch (props.props) {
        case 'clear sky':
            return (
                <Image
                    style={{ marginTop: hp(1), width: wp(60), height: wp(60), alignSelf: "center" }}
                    source={
        ...
        return (
            <View style={styles.container2}>
                ...
                <View style={{ marginTop: hp(5), alignSelf: "center", width: wp(70), height: hp(40), backgroundColor: "#FF8000", borderRadius: 20 }}>
                    ...
                    <ShowImg props={data.weather[0].description} />

                    <Text style={{ color: "#FFFFFF", textAlign: "center", fontSize: hp(4.5), fontWeight: "bold" }}>{data.weather[0].description}</Text>
                </View>
